...
if __name__ == "__main__":
    ...
    #Import raw data
    df_system_book = fileLoader("03_Library Systembook.csv")
    df_system_customers =fileLoader("03_Library SystemCustomers.csv")
...
##Added to print to terminal
    print("\nCLEAN BOOK DATA")
    print(df_system_book.head())

    print("\nCLEAN CUSTOMER DATA")
    print(df_system_customers.head())